export default function Page() {
  return (
    <main>
      ...
      <p id="text" data-pre="" data-live="">–</p>
      <div id="countdown" style={{ fontVariantNumeric: "tabular-nums", fontSize: 22, fontWeight: 700 }}>–</div>
      <p id="info" style={{ color: "#8aa0c7", maxWidth: 520 }}></p>
      <div id="status" style={{ marginTop: 20, padding: "8px 16px", borderRadius: 999, background: "#0e1628", border: "1px solid rgba(148,163,184,.2)" }}>
        Status: –
      </div>
          ...
          (function(){
            ...
            async function tick(){
              try{
                ...
                if(!start){
                  textEl.textContent = cfg.preText || '–';
                  cdEl.textContent = '–';
                ...
                if(now < start){
                  ...
                  textEl.textContent = cfg.liveText || 'Die Inventur ist gestartet.';
